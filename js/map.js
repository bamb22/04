...
function initialize() {
  ...
  /*
  	...
  	해커스 종로캠퍼스 : @37.571861,126.9869484
  	일산 하이미디어 : @37.6581203,126.771482,17z
  */
  var Y_point = 37.6581203; // Y 좌표
  var X_point = 126.771482; // X 좌표

  var zoomLevel = 15; // 첫 로딩시 보일 지도의 확대 레벨

  var markerTitle = "일산 하이미디어"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
  ...
  var contentString = '<div id="content">' +
    ...
    '<div id="bodyContent">' +
    '<p>하이미디어 종로캠퍼스입니다!<br /><a href="http://media.co.kr" target="_blank">http://media.co.kr</a></p>' +
    '</div>' +
    '</div>';
